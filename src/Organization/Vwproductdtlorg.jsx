    ...
    <div>
        <div className='basicbg w-[100%] '>
            ...
            <div className='flex flex-wrap'>
              <div className='bg-yellow-300/40 w-[50%] h-[40rem]'>
                <div className='w-[40px] h-[40px]'> <img src={backarrow} alt="" /></div>
                <div className='pt-12'><img className=' h-[25rem] w-[20rem] m-auto '  src={purpledress} alt="" /></div>
...
<form class="max-w-xs mx-auto pt-3">
    ...
    <div class="relative flex items-center max-w-[8rem]">
        ...
        <input type="text" id="quantity-input" data-input-counter aria-describedby="helper-text-explanation" class="bg-orange-200 border-x-0 border-orange-500 h-11 text-center text-black text-sm focus:ring-orange-500 focus:border-orange-500 block w-full py-2.5 dark:bg-orange-200 dark:border-orange-500 dark:placeholder-slate-600 dark:text-black dark:focus:ring-orange-500 dark:focus:border-orange-500" placeholder="999" required />
