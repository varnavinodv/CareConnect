...
const Vworderuser = () => {
    ...
    let handleSubmit = async (status, id,productId) => {
        // setData(data)
        // console.log(data);
        // navigate('/organization/viewdeliveryboyorg')
        let response = await axios.put(`http://localhost:4000/user/acceptorder/${id}/${productId}`, { ...data, status: status })
                                                ...
                                                {item1.Ostatus == 'assigned' || item1.Ostatus == 'pending' ?
                                                    ...
                                                    <>
                                                        <div className='flex flex-col'>
                                                            <a href="#" class="font-bold text-sm text-green-600 hover:underline hover:bg-white p-1" onClick={() => { handleSubmit('Accepted', item1._id,item.productdetail._id) }} >Accept</a>
                                                            <a href="#" class="font-bold text-sm text-red-600 hover:underline hover:bg-white p-1" onClick={() => { handleSubmit('Rejected',item1._id,item.productdetail._id) }} >Reject</a>
